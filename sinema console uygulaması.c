...
int main()
{
    ...
    char sifre[20];
    printf("Menuyu gormek icin kullanici adi ve sifreyi giriniz.(ORN: kullanici adi : simge. Sifre : 123 ise simge 123 seklinde giriniz.)(kullanici adi enter.)\n"); gets(sifre);
    ...
    printf("------------------------------------------------------------------------------\n");
    printf("Yapmak istediginiz islemi seciniz :"); scanf("%d",&menuSecimi);
    char salonsecimi;
    int matine;
    Salonlar *psalon;
    psalon = &salon;
